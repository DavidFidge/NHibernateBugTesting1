...
namespace NHibernateBug {
    class Program {
        static readonly string connectionString = @"Data Source=.; initial catalog=NHibernateBug; TrustServerCertificate=true; Trusted_Connection=true; Encrypt=false";
...
<hibernate-mapping xmlns=""urn:nhibernate-mapping-2.2"">
  <class name=""NHibernateBug.Entity, NHibernateBug"" table=""{Program.tableName}"" lazy=""false"">
